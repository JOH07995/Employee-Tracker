...
// this was a really verbose way to approach this homework, there are opportunities to simplify and refactor this app
// not sure if framing with CRUD was a great option, but it's good enough
const prompts = {
    main: {
        name: `CRUD`,
        type: `list`,
